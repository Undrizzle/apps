...
#define DEV_AGE_INTERRUPT  ( DEV_88E6108 | DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_AGE_INTERRUPT       ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_AGE_INT_GLOBAL2    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_AGE_INT_GLOBAL2     (G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY)    
#define DEV_AGE_OUT_INT        ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_AGE_OUT_INT     ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_AGE_HOLD        ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_AGE_HOLD         ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

#define DEV_DEVICE_INTERRUPT    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_DEVICE_INTERRUPT    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_DEVICE_INT_TYPE1    ( DEV_88E6097_FAMILY )    /* Serdes Int bit[10:8] */
#define G1_DEV_DEVICE_INT_TYPE1    0    /* Serdes Int bit[10:8] */
#define DEV_DEVICE_INT_TYPE2    ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )    /* Serdes Int bit[12:11], Phy Int bit[4:0] */
#define G1_DEV_DEVICE_INT_TYPE2    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )    /* Serdes Int bit[12:11], Phy Int bit[4:0] */

#define DEV_WATCHDOG_EVENT    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_WATCHDOG_EVENT    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

#define DEV_PORT_BASED_AGE_INT    ( DEV_88E6065_FAMILY )
#define G1_DEV_PORT_BASED_AGE_INT    0
#define DEV_DEV_PHY_INTERRUPT    ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )    /* device interrupt includes phy int */
#define G1_DEV_DEV_PHY_INTERRUPT    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )    /* device interrupt includes phy int */

#define DEV_AVB_INTERRUPT      ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_AVB_INTERRUPT      ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

#define DEV_AUTO_REFRESH_LOCKED    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_AUTO_REFRESH_LOCKED    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

#define DEV_PPU_PHY_ACCESS    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_PPU_PHY_ACCESS    0
#define DEV_PPU_PHY_ACCESS_RES    ( DEV_88E6097_FAMILY )
#define G1_DEV_PPU_PHY_ACCESS_RES    0

#define DEV_PPU_READ_ONLY    ( DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_PPU_READ_ONLY    0

#define DEV_PPU_SERDES_ACCESS_RES    ( DEV_88E6165_FAMILY )
#define G1_DEV_PPU_SERDES_ACCESS_RES    0

#define DEV_NO_EGRESS_POLICY    ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
...
#define DEV_ATU_LIMIT        ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_ATU_LIMIT    0

#define DEV_ATU_LIMIT_READ    ( DEV_88E6351_FAMILY )
...
#define DEV_DBNUM_4096     ( DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
...
#define DEV_STATIC_ADDR    ( DEV_88E6060 | DEV_88E6021 | DEV_FF_EG | DEV_FF_HG | DEV_88E6052 | DEV_88E6063 | \
      ...
      DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_STATIC_ADDR    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define DEV_HEADER    ( DEV_FF_HG | DEV_88E6063 | DEV_FH_VPN | DEV_88E6083 |    DEV_88E6183 | \
      ...
      DEV_88E6065_FAMILY | DEV_88E6097_FAMILY |  DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_HEADER    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define G1_DEV_QoS    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define DEV_PRIORITY_REMAPPING        ( DEV_88E6181 | DEV_88E6183 | DEV_88E6093 | DEV_88E6095 | \
    DEV_88E6185 | DEV_88E6108 | DEV_88E6065 | DEV_88E6097_FAMILY | DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_PRIORITY_REMAPPING  ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define DEV_RMON    ( DEV_88E6021 | DEV_88E6063 | DEV_FH_VPN |     \
              ...
              DEV_88E6165_FAMILY | DEV_88E6351_FAMILY ) 
#define G1_DEV_RMON    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY ) 
...
#define DEV_RMON_TYPE_3     \
        ( DEV_88E6093 | DEV_88E6095 | DEV_88E6092 |     \
          ...
          DEV_88E6097_FAMILY |        \
          DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_RMON_TYPE_3 ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_RMON_REALTIME_SUPPORT    \
        ( DEV_88E6065 | DEV_88E6065_FAMILY |    \
          DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |    \
          DEV_88E6351_FAMILY )
#define G1_DEV_RMON_REALTIME_SUPPORT    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY)
#define DEV_RMON_PORT_BITS    ( DEV_88E6065 | DEV_88E6065_FAMILY )
#define G1_DEV_RMON_PORT_BITS    \
   ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY)
...
#define DEV_EGRESS_RATE_KBPS    \
    ( DEV_FF_HG | DEV_88E6063 | DEV_FH_VPN |            \
      ...
      DEV_88E6097_FAMILY | DEV_88E6165_FAMILY |         \
      DEV_88E6351_FAMILY )
#define G1_DEV_EGRESS_RATE_KBPS    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY)
...
#define G1_DEV_ENHANCED_FE_SWITCH    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define DEV_PCS_LINK    ( DEV_88E6093 | DEV_88E6095_FAMILY |     \
              ...
              DEV_88E6165_FAMILY | DEV_88E6351_FAMILY )
#define G1_DEV_PCS_LINK    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define G1_DEV_POLICY    ( G1_DEV_88E6351_FAMILY | G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define G1_DEV_JUMBO_MODE  \
    ( G1_DEV_88E6165_FAMILY | G1_DEV_88E6351_FAMILY | G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_PTP        ( DEV_88E6165_FAMILY | DEV_88E6351_AVB_FAMILY )
#define G1_DEV_PTP    \
    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_PTP_2        ( DEV_88E6351_AVB_FAMILY )
#define G1_DEV_PTP_2        ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define G1_DEV_QAV    \
    ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_QAV_QPRI_QTS_TOKEN        ( DEV_88E6351_AVB_FAMILY )
#define G1_DEV_QAV_QPRI_QTS_TOKEN    0
...
#define G1_DEV_200BASE_CFG        ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_RGMII_TIMING    ( DEV_88E6351_FAMILY )
#define G1_DEV_RGMII_TIMING        ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_Q_COUNTER_TABLE    ( DEV_88E6351_FAMILY )
#define G1_DEV_Q_COUNTER_TABLE        ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_LED_CFG        ( DEV_88E6351_FAMILY )
#define G1_DEV_LED_CFG            ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

#define DEV_MAC_AVB        ( DEV_88E6351_AVB_FAMILY )
#define G1_DEV_MAC_AVB            ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

#define DEV_CLK_125        ( DEV_88E6351_FAMILY )
#define G1_DEV_CLK_125            ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
...
#define G1_DEV_SCRATCH_MISC_CTRL        ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_IP_MAPPING_TABLE        ( DEV_88E6351_FAMILY )
#define G1_DEV_IP_MAPPING_TABLE            ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )
#define DEV_EEPROM            ( DEV_88E6351_FAMILY )
#define G1_DEV_EEPROM            ( G1_DEV_88E6351_FAMILY)

#define DEV_RMGMT        (DEV_88E6351_FAMILY | DEV_88E6097_FAMILY |DEV_88E6165_FAMILY)
#define G1_DEV_RMGMT        ( G1_DEV_88EC000_FAMILY | G1_DEV_88ESPANNAK_FAMILY )

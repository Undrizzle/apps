...
)
{
...
#ifdef GT_RMGMT_ACCESS
    {
      ...
      (*mac).arEther[0] = (regAccess.rw_reg_list[0].data >> 8) & ~0x01;
      (*mac).arEther[1] = regAccess.rw_reg_list[0].data & 0xFF;
      (*mac).arEther[2] = regAccess.rw_reg_list[1].data >> 8;
      (*mac).arEther[3] = regAccess.rw_reg_list[1].data & 0xFF;
      (*mac).arEther[4] = regAccess.rw_reg_list[2].data >> 8;
      (*mac).arEther[5] = regAccess.rw_reg_list[2].data & 0xFF;
    }
#else
...
)
{
...
#ifdef GT_RMGMT_ACCESS
    {
      ...
      data = regAccess.rw_reg_list[2].data;
    }
#else
    do
    {

...
*
* Purpose : IGMP snooping debug API
*
* Feature : 
*
*/
#ifndef __RTL_IGMP_SNOOPING_LOCAL_H__
#define __RTL_IGMP_SNOOPING_LOCAL_H__
...
extern void rtl_igmpDump(uint32 dumpOpration, uint32 groupAddress);
extern void rtl_setCpuPortNum(uint32 cpuPortNum);
extern void rtl_setMCastDataToCpu(uint32 toCpuFlag);
extern void rtl_setCpuIsIgmpRouter(uint32 cpuIsIgmpRouter);
extern int32 rtl_checkGroupStatus(uint32 groupAddress, uint32 *lutFlag, uint32 *aggregatorFlag);
#endif

#endif /* __RTL_IGMP_SNOOPING_LOCAL_H__ */

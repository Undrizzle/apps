...
------------------------------------------------------------------------
  ...
  the cnuTable table.  The agent will start by looking for the right
  ...
  file defaults/table-cnuTable.m2d, and then re-running mib2c.
 ...
 Index(es) for the cnuTable table
  ------------------------------------------------------------
  The index(es) for the cnuTable table are:
...
************************************************************************
cnuTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the cnuTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: cnuTable_data_access.[c|h]
------------------------------------------------------------------------
  The cnuTable_data_access file contains the interface to your data in
  ...
  FUNC : cnuTable_indexes_set
  WHERE: cnuTable_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cnuMacAddress_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cnuOnlineStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cnuAuthorized_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cnuSoftwareVersion_get
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cnuSynchronized_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cnuRowStatus_get



File: cnuTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-cnuTable.m2d
  ...
  FUNC : cnuTable_check_dependencies
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the cnuTable table.

To watch the flow of the cnuTable table, use the
...
e.g.
        snmpd -f -Le -DcnuTable,verbose:cnuTable,internal:cnuTable
...
/*---------------------------------------------------------------------
 * prevail-mib::cnuEntry.cnuTid
 * cnuTid is subid 1 of cnuEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.36186.8.1.1.1
 * Description:

...
------------------------------------------------------------------------
  ...
  the cltTable table.  The agent will start by looking for the right
  ...
  file defaults/table-cltTable.m2d, and then re-running mib2c.
 ...
 Index(es) for the cltTable table
  ------------------------------------------------------------
  The index(es) for the cltTable table are:
...
************************************************************************
cltTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the cltTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: cltTable_data_access.[c|h]
------------------------------------------------------------------------
  The cltTable_data_access file contains the interface to your data in
  ...
  FUNC : cltTable_indexes_set
  WHERE: cltTable_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltMacAddress_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltOnlineStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltMaxStats_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltNumStats_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltSoftwareVersion_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltSynchronized_get
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cltRowStatus_get



File: cltTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-cltTable.m2d
  ...
  FUNC : cltTable_check_dependencies
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the cltTable table.

To watch the flow of the cltTable table, use the
...
e.g.
        snmpd -f -Le -DcltTable,verbose:cltTable,internal:cltTable
...
/*---------------------------------------------------------------------
 * prevail-mib::cltEntry.cltTid
 * cltTid is subid 1 of cltEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.36186.8.9.1.1
 * Description:

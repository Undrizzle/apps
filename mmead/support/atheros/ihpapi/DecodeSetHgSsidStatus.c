#ifndef DECODESETHGSSIDSTATUS_SOURCE
#define DECODESETHGSSIDSTATUS_SOURCE
...
int ihp_DecodeSetHgSsidStatus(const uint8_t buffer [ ], size_t length, ihpapi_result_t * result)

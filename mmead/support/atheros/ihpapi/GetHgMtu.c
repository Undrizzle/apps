#ifndef GETHGMTU_SOURCE
#define GETHGMTU_SOURCE
...
{
	struct __packed vs_get_hg_mtu_req 
	{
	...
	* request = (struct vs_get_hg_mtu_req *)(buffer);
	...
	request->extend_SubType = ihtons(0x1003);

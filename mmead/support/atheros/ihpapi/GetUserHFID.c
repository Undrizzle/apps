#ifndef GETUSERHFID_SOURCE
#define GETUSERHFID_SOURCE
...

{
	...
	offset += EncodeIntellonHeader (buffer + offset, bufferLen - offset, (VS_GET_PROPERTY | MMTYPE_REQ));   //MMV,MMTYPE,OUI

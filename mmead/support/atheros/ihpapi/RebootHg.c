#ifndef REBOOTHG_SOURCE
#define REBOOTHG_SOURCE
...
{
	struct __packed vs_hg_reboot_req 
	{
	...
	* request = (struct vs_hg_reboot_req *)(buffer);
	...
	request->extend_SubType = ihtons(0x2001);

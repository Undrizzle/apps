#ifndef GETHGWANSTATUS_SOURCE
#define GETHGWANSTATUS_SOURCE
...
{
	struct __packed vs_get_hg_wan_status_req 
	{
	...
	* request = (struct vs_get_hg_wan_status_req *)(buffer);
	...
	request->extend_SubType = ihtons(0x1004);

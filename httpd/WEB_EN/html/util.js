...
function isValidVlanPriority(priority) {
	var msg;
	var value;
	if ( isNaN(parseInt(priority)) == true )
	{
		msg = 'Vlan Priority "' + priority + '" is invalid.';
		alert(msg);
		return false;
	}
	...
	if ( value < 0 || value > 7 )
	{
            msg = 'Vlan Priority "' + priority + '" is out of range [0-7].';
            alert(msg);
            return false;
     }
	return true;

...
//	fprintf(fs, "	</div>\n");
	...
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='1'><input id='ssid_name2' value='%s'>\n",glbWebVar.ssid_name2);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	...
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='2'><input id='ssid_name3' value='%s'>\n",glbWebVar.ssid_name3);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	...
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='3'><input id='ssid_name4' value='%s'>\n",glbWebVar.ssid_name4);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");

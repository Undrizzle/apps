...
void cgiCnuWifi(char *query, FILE *fs)
{
	...
	fprintf(fs, "function MtuRead() {\n");
	fprintf(fs, "	var loc = 'MtuRead.cgi?';\n");
	fprintf(fs, "	loc += 'cnuid=' + %d;\n", id);
	fprintf(fs, "	var code = 'location=\"' + loc + '\"';\n");
	fprintf(fs, "	eval(code);\n");
	fprintf(fs, "}\n");

	fprintf(fs, "function MtuWrite() {\n");
	fprintf(fs, "}\n");
...
//	fprintf(fs, "	</div>\n");
	...
	fprintf(fs, "			<table border=0 cellpadding=0 cellspacing=0>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>MTU</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<input id='mtu'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr><td class='diagdata' colspan=2>&nbsp;</td></tr>\n");
	fprintf(fs, "				<tr>\n");

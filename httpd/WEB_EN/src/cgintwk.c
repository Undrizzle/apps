...
void cgiCnuProfileExt(char *query, FILE *fs)
{
	...
	fprintf(fs, "	if ( $('#vlanStatus').val() == 1 )\n");
	fprintf(fs, "	{\n");
...
void cgiCnuWifi(char *query, FILE *fs)
{
	...
	fprintf(fs, "function Ssid1StatusWrite() {\n");
	fprintf(fs, "	var loc = 'Ssid1StatusWrite.cgi?';\n");
	fprintf(fs, "	loc += 'cnuid=' + %d;\n", id);
	fprintf(fs, "	if($('input[name=ssid_status][value=0]').is(':checked')) {\n");
	fprintf(fs, "		loc += '&ssid1Status=1';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	else {\n");
	fprintf(fs, "		loc += '&ssid1Status=0';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	loc += '&ssid1Name=' + $('#ssid_name1').val();\n");
	fprintf(fs, "	loc += '&ssid1Pwd=' + $('#ssid_pwd1').val();\n");
	fprintf(fs, "	var code = 'location=\"' + loc + '\"';\n");
	fprintf(fs, "	//alert(code);\n");
	fprintf(fs, "	eval(code);\n");
	fprintf(fs, "}\n");

	fprintf(fs, "function Ssid2StatusWrite() {\n");
	fprintf(fs, "	var loc = 'Ssid2StatusWrite.cgi?';\n");
	fprintf(fs, "	loc += 'cnuid=' + %d;\n", id);
	fprintf(fs, "	if($('input[name=ssid_status][value=1]').is(':checked')) {\n");
	fprintf(fs, "		loc += '&ssid2Status=1';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	else {\n");
	fprintf(fs, "		loc += '&ssid2Status=0';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	loc += '&ssid2Name=' + $('#ssid_name2').val();\n");
	fprintf(fs, "	loc += '&ssid2Pwd=' + $('#ssid_pwd2').val();\n");
	fprintf(fs, "	var code = 'location=\"' + loc + '\"';\n");
	fprintf(fs, "	//alert(code);\n");
	fprintf(fs, "	eval(code);\n");
	fprintf(fs, "}\n");

	fprintf(fs, "function Ssid3StatusWrite() {\n");
	fprintf(fs, "	var loc = 'Ssid3StatusWrite.cgi?';\n");
	fprintf(fs, "	loc += 'cnuid=' + %d;\n", id);
	fprintf(fs, "	if($('input[name=ssid_status][value=2]').is(':checked')) {\n");
	fprintf(fs, "		loc += '&ssid3Status=1';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	else {\n");
	fprintf(fs, "		loc += '&ssid3Status=0';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	loc += '&ssid3Name=' + $('#ssid_name3').val();\n");
	fprintf(fs, "	loc += '&ssid3Pwd=' + $('#ssid_pwd3').val();\n");
	fprintf(fs, "	var code = 'location=\"' + loc + '\"';\n");
	fprintf(fs, "	//alert(code);\n");
	fprintf(fs, "	eval(code);\n");
	fprintf(fs, "}\n");

	fprintf(fs, "function Ssid4StatusWrite() {\n");
	fprintf(fs, "	var loc = 'Ssid4StatusWrite.cgi?';\n");
	fprintf(fs, "	loc += 'cnuid=' + %d;\n", id);
	fprintf(fs, "	if($('input[name=ssid_status][value=3]').is(':checked')) {\n");
	fprintf(fs, "		loc += '&ssid4Status=1';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	else {\n");
	fprintf(fs, "		loc += '&ssid4Status=0';\n");
	fprintf(fs, "	}\n");
	fprintf(fs, "	loc += '&ssid4Name=' + $('#ssid_name4').val();\n");
	fprintf(fs, "	loc += '&ssid4Pwd=' + $('#ssid_pwd4').val();\n");
	fprintf(fs, "	var code = 'location=\"' + loc + '\"';\n");
	fprintf(fs, "	//alert(code);\n");
	fprintf(fs, "	eval(code);\n");
	fprintf(fs, "}\n");

	fprintf(fs, "function WanStatusRead() {\n");
	fprintf(fs, "	var loc = 'WanStatusRead.cgi?';\n");
	fprintf(fs, "	loc += 'cnuid=' + %d;\n",id);
	fprintf(fs, "	var code = 'location=\"' + loc + '\"';\n");
	fprintf(fs, "	eval(code);\n");
	fprintf(fs, "}\n");
	...
	fprintf(fs, "		event.preventDefault();\n");
	fprintf(fs, "		Ssid1StatusWrite();\n");
	fprintf(fs, "	});\n");
	fprintf(fs, "	$('#write4Btn').button().click(function(event) {\n");
	fprintf(fs, "		event.preventDefault();\n");
	fprintf(fs, "		Ssid2StatusWrite();\n");
	fprintf(fs, "	});\n");
	fprintf(fs, "	$('#write5Btn').button().click(function(event) {\n");
	fprintf(fs, "		event.preventDefault();\n");
	fprintf(fs, "		Ssid3StatusWrite();\n");
	fprintf(fs, "	});\n");
	fprintf(fs, "	$('#write6Btn').button().click(function(event) {\n");
	fprintf(fs, "		event.preventDefault();\n");
	fprintf(fs, "		Ssid4StatusWrite();\n");
	fprintf(fs, "	});\n");
...
//	fprintf(fs, "	</div>\n");
	...
	fprintf(fs, "				<tr><td class='diagdata' colspan=2>&nbsp;</td></tr>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>SSID Status</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>SSID Name</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>SSID Password</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr><td class='diagdata' colspan=2>&nbsp;</td></tr>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='0'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_name1' value='%s'>\n", glbWebVar.ssid_name1);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_pwd1' value='%s'>\n",glbWebVar.ssid_pwd1);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	...
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='1'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_name2' value='%s'>\n",glbWebVar.ssid_name2);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<input id='ssid_pwd2' value='%s'>\n",glbWebVar.ssid_pwd2);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<button id='write4Btn'>Wrtie</button>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='2'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_name3' value='%s'>\n",glbWebVar.ssid_name3);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_pwd3' value='%s'>\n",glbWebVar.ssid_pwd3);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<button id='write5Btn'>Write</button>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input name='ssid_status' type='checkbox' value='3'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_name4' value='%s'>\n",glbWebVar.ssid_name4);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=200>\n");
	fprintf(fs, "						<input id='ssid_pwd4' value='%s'>\n", glbWebVar.ssid_pwd4);
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<button id='write6Btn'>Write</button>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr><td class='diagdata' colspan=2>&nbsp;</td></tr>\n");
	fprintf(fs, "				<tr>\n");
	...
	fprintf(fs, "	<h3>WAN Management</h3>\n");
	fprintf(fs, "	<div>\n");
	fprintf(fs, "		<div class='dwall'>\n");
	fprintf(fs, "			<table border=0 cellpadding=0 cellspacing=0>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>WAN Status</td>\n");
	fprintf(fs, "				</tr>\n");
	fprintf(fs, "				<tr><td class='diagdata' colspan=2>&nbsp;</td></tr>\n");
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input id='wan_name_1'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<select id='wan_status_1' size=1>\n");
	fprintf(fs, "							<option value='0'>Disable</option>\n");
	fprintf(fs, "							<option value='1'>Enable</option>\n");
	fprintf(fs, "						</select>\n");
	fprintf(fs, "					</td>\n");
	...
	fprintf(fs, "				<tr>\n");
	fprintf(fs, "					<td class='diagdata' width=250>\n");
	fprintf(fs, "						<input id='wan_name_2'>\n");
	fprintf(fs, "					</td>\n");
	fprintf(fs, "					<td class='diagdata' width=300>\n");
	fprintf(fs, "						<select id='wan_status_2' size=1>\n");
	fprintf(fs, "							<option value='0'>Disable</option>\n");
	fprintf(fs, "							<option value='1'>Enable</option>\n");
	fprintf(fs, "						</select>\n");
	fprintf(fs, "					</td>\n");
